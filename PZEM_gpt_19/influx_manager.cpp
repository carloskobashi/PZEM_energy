...
//------------- Diagnóstico -------------
    ...
    pzemPoint.addField("severity", (int)analysis.data.severity);
    pzemPoint.addField("possibleMechanicalProblem", analysis.data.possibleMechanicalProblem);
    pzemPoint.addField("possibleElectricalProblem", analysis.data.possibleElectricalProblem);
    pzemPoint.addField("totalEvents", (int32_t)analysis.data.totalEvents);
    pzemPoint.addField("motorState", (int)analysis.data.motorState);
